 ...
 */
@Configuration
@ComponentScan(value="org.docksidestage.upgrade.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new org.docksidestage.upgrade.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new org.docksidestage.upgrade.dbflute.allcommon.ImplementedInvokerAssistant();
    }
