...
public class PurchasePaymentDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPurchasePaymentId = cci("PURCHASE_PAYMENT_ID", "PURCHASE_PAYMENT_ID", null, "購入支払ID", Long.class, "purchasePaymentId", null, true, true, true, "BIGINT", 19, 0, null, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_304DF364_9ADA_4F3D_A3A2_B81BFE2F24FB", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.upgrade.dbflute.exentity.PurchasePayment"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.upgrade.dbflute.cbean.PurchasePaymentCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.upgrade.dbflute.exbhv.PurchasePaymentBhv"; }
