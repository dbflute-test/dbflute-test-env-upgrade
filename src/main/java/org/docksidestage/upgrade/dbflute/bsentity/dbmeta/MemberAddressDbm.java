...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberAddressId = cci("MEMBER_ADDRESS_ID", "MEMBER_ADDRESS_ID", null, "会員住所ID", Integer.class, "memberAddressId", null, true, true, true, "INTEGER", 10, 0, null, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_57FF5C9C_B7AD_4864_A5BC_50D7C9693BEC", false, null, null, null, null, null, false);
